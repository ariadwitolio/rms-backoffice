  ...
  return {
    ...
    "device-management": [
      ...
      },
      {
        ...
        status: "Connected",
        deviceConnected:
          "iPad (9th Gen), Samsung Galaxy Tab S7, Samsung Galaxy Tab S8, Samsung Galaxy Tab S9",
        connectedDevices: [
          "Cashier Tablet A",
          "Kitchen Tablet 01",
          "Waiter Tablet B",
          "Cashier Dual Screen A",
        ],
        connectionType: "LAN",
      ...
      {
        id: "dm-009",
        deviceName: "Patio Printer E",
        pairingCode: "PRT - 2207 - 021",
        deviceType: "Printer",
        status: "Connected",
        deviceConnected: "Samsung Galaxy Tab S6",
        connectedDevices: ["Cashier Dual Screen A"],
        connectionType: "LAN",
        ipAddress: "192.168.1.25",
        bluetoothId: null,
        deviceOs: "Firmware 3.2",
